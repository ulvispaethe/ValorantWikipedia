...
const Header = () => {
  ...
  return (
    <div className='py-3 px-10 flex justify-between items-center bg-red-500 w-[100%]'>
        <div onClick={()=>navigate("/")} className='flex items-center gap-2 cursor-pointer'><img  className=' w-[6%] h-[6%]' src="https://yoolk.ninja/wp-content/uploads/2020/06/Games-Valorant-1024x1024.png" alt="" /> <h1 className='font-extrabold text-3xl'>Valorant Wikipedia</h1> </div>
